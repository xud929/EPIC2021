...
int main(int argc, char* argv[]){
    ...
    ip2ip_beta1=DBL0(IP2IPX1,beta);
    ip2ip_beta2=DBL1(IP2IPX1,beta);
    ip2ip_alpha1=DBL0(IP2IPX1,alpha);
    ip2ip_alpha2=DBL1(IP2IPX1,alpha);
    ip2ip_phase=DBL0(IP2IPX1,dphase);
    LinearX ip2ipX1(ip2ip_beta1,ip2ip_alpha1,ip2ip_beta2,ip2ip_alpha2,ip2ip_phase);
    ip2ip_beta1=DBL0(IP2IPY1,beta);
    ip2ip_beta2=DBL1(IP2IPY1,beta);
    ip2ip_alpha1=DBL0(IP2IPY1,alpha);
    ip2ip_alpha2=DBL1(IP2IPY1,alpha);
    ip2ip_phase=DBL0(IP2IPY1,dphase);
    LinearY ip2ipY1(ip2ip_beta1,ip2ip_alpha1,ip2ip_beta2,ip2ip_alpha2,ip2ip_phase);
    ip2ip_beta1=DBL0(IP2IPX2,beta);
    ip2ip_beta2=DBL1(IP2IPX2,beta);
    ip2ip_alpha1=DBL0(IP2IPX2,alpha);
    ip2ip_alpha2=DBL1(IP2IPX2,alpha);
    ip2ip_phase=DBL0(IP2IPX2,dphase);
    LinearX ip2ipX2(ip2ip_beta1,ip2ip_alpha1,ip2ip_beta2,ip2ip_alpha2,ip2ip_phase);
    ip2ip_beta1=DBL0(IP2IPY2,beta);
    ip2ip_beta2=DBL1(IP2IPY2,beta);
    ip2ip_alpha1=DBL0(IP2IPY2,alpha);
    ip2ip_alpha2=DBL1(IP2IPY2,alpha);
    ip2ip_phase=DBL0(IP2IPY2,dphase);
    LinearY ip2ipY2(ip2ip_beta1,ip2ip_alpha1,ip2ip_beta2,ip2ip_alpha2,ip2ip_phase);
    ...
    */
    ...
    while(current_turn<total_turns){
        for(int i=0;i<output_turns;++i){
            ...
            wb1.Pass(rlb,MX31,tcca1,MX41);
            wb2.Pass(rlb,MX32,tcca2,MX42);

            // IP1 to IP2
            wb1.Pass(ip2ipX1,ip2ipY1);
            wb2.Pass(ip2ipX2,ip2ipY2);
